...
export default function OneImage() {
  return (
    <div data-aos="fade-up" className="bg-[#F46C67] w-[100%] p-10 self-center flex flex-col justify-center items-center">
      <Image src="/images/widecalf.jpg" alt="" width={900} height={300} />
